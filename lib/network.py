...
class vgg16_convs(nn.Module):
    def __init__(self, num_classes):
        ...
        self.conv8_seman = nn.Conv2d(in_channels=64, out_channels=self.num_classes + 1, kernel_size=3, stride=1,
                                     padding=1)
        ...
        self.dconv7_center = nn.ConvTranspose2d(in_channels=128, out_channels=128,
                                                kernel_size=16, stride=8, padding=4, output_padding=0)
        self.conv8_center = nn.Conv2d(in_channels=128, out_channels=3 * self.num_classes, kernel_size=3, stride=1,
                                      padding=1)
